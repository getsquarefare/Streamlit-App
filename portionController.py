...
class MealRecommendation:
    ...
    def get_default_recommendation_summary(
            ...
            recommendation_summary = {
                ...
                "Delivery Date": "NA",
                "All Deletions": deletions,
                "Meat": ", ".join([ing["ingredientName"] for ing in dish if ing["Component"] == "protein"]),
                "Meat (g)": meat_g,
                "Sauce": ", ".join([ing["ingredientName"] for ing in dish if ing["Component"] == "sauce"]),
                "Sauce (g)": sauce_g,
                "Starch": ", ".join([ing["ingredientName"] for ing in dish if ing["Component"] == "starch"]),
                "Starch (g)": starch_g,
                "Veggies": ", ".join([ing["ingredientName"] for ing in dish if ing["Component"] == "veggies"]),
                "Veggies (g)": veggies_g,
                "Garnish": ", ".join([ing["ingredientName"] for ing in dish if ing["Component"] == "garnish"]),
                "Garnish (g)": garnish_g,
